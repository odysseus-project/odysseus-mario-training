...
class TestConfigComparison(unittest.TestCase):
    ...
    def test_ppo_trainer_config_matches_legacy(self):
        ...
        try:
            ...
            # Dynamic data generation was retired from this training release.
            # Preserve the historical fixture; omit only that removed field here.
            legacy_dict["data"].pop("datagen", None)
